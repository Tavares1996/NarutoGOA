...
obj/gui/passives
	...
	rfx
		Weak_Spot
			max=5
			pindex=14
			disc="5% Chance on Hit for projectiles to cause 1-2 wound damage per level of this passive."
		Projectile_Master
			max=10
	...
	con
		Efficiency
			max=5
			pindex=5
			disc="Each level of this passive reduces chakra costs for skills by 4% and when maxed allows to do Seals while running"
		Powerhouse
			max=5
			pindex=22
