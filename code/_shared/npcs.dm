mob/human/player/npc
	var
		...
		onquest=0
		list/skillsx
		dietype=2 //0=KO,no death 1=delayed respawn 2=death till repop
		respawndelay=1200
		delay=5
		range=10
		agrange=3
	...
	Konoha_Civ6_Uchiha
		...
		delay=2
		skillsx=list(KAWARIMI,WINDMILL_SHURIKEN,BUNSHIN,HENGE,PARALYZE_GENJUTSU,SLEEP_GENJUTSU,KATON_PHOENIX_FIRE,KATON_ASH_BURNING,SHUNSHIN,SHUNSHIN,SHUNSHIN,SHUNSHIN,SHARINGAN2,3,SHARINGAN2,SHARINGAN2,SHARINGAN2,SHARINGAN2)
	Kawa_1
